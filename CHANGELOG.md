...
- New feature: Added "Share settings" button in the Settings modal; copy your current game settings to the clipboard as a URL; visiting the link applies those settings automatically (unless a game is in progress).
