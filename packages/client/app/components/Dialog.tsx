  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark-bg-secondary text-dark-text-primary rounded-lg shadow-lg p-6 w-full max-w-[calc(430px-1rem)] max-h-[90vh] overflow-y-auto">
